...
function recalc() {
  ...
  const finalMRP = totalCostPerPiece * (1 + mrpPercent / 100);
  ...
  document.getElementById("calcTotalCost").textContent = "₹" + totalCostPerPiece.toFixed(2);
  document.getElementById("calcMRP").textContent = "₹" + finalMRP.toFixed(2);

  return { clothUsed, fabricCostPerPiece, totalFabricCost, totalCostPerPiece, finalMRP };
}
